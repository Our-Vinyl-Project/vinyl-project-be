...
app.use(`${process.env.ROUTE_PREFIX}/api/v1/wants`, require('./routes/wants.js'));
app.use(`${process.env.ROUTE_PREFIX}/api/v1/items`, require('./routes/items.js'));
app.use(`${process.env.ROUTE_PREFIX}/api/v1/chart`, require('./routes/price.js'));
