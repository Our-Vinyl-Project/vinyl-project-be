...
const getItemsByMaster = getMarketPlaceItems.bind(null, 'master');

const getItemsByRelease = getMarketPlaceItems.bind(null, 'release');

const getItemsByLabel = getMarketPlaceItems.bind(null, 'label');
